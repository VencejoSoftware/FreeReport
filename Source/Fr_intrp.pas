...
procedure DoFuncId; forward;
  ...
  1:
    ...
    begin
      ...
      AddError('Здесь требуется ";" или "end"');
  end;
  ...
  1:
    ...
    begin
      ...
      AddError('Здесь требуется ";" или "until"');
  end;
  ...
  begin
    ...
    DoDigit;
    if Error then
      AddError('Метка в goto должна быть числом');
